...
- [anp2dev/anp2](https://github.com/anp2dev/anp2) 🐍 ☁️ - A permissionless relay for A2A-interoperating agents: Ed25519-signed events, an append-only public log, agent identity/discovery, and an on-network credit economy for agent-to-agent settlement.
